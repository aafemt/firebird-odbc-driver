...
static Types types [] =
{
	...
	ALPHA ("VARCHAR", JDBC_WVARCHAR, MAX_WVARCHAR_LENGTH),
	ALPHA ("CHAR", JDBC_WCHAR, MAX_WCHAR_LENGTH),
	...
	NUMERIC ("BIGINT", -5, MAX_QUAD_LENGTH,"", 0, MAX_QUAD_LENGTH, 10),
	BLOB ("BLOB SUB_TYPE 0", JDBC_LONGVARBINARY, MAX_BLOB_LENGTH, "","",CASE_INSENSITIVE),
	BLOB ("VARBINARY", JDBC_VARBINARY, MAX_BLOB_LENGTH, "","",CASE_INSENSITIVE),
	BLOB ("BINARY", JDBC_BINARY, MAX_BLOB_LENGTH, "","",CASE_INSENSITIVE),
	...
	DATE("DATE",9,MAX_TIMESTAMP_LENGTH,"date'","'",1),
	DATETIME("TIME",9,MAX_TIME_LENGTH,"time'","'",2),
	DATETIME("TIMESTAMP",9,MAX_TIMESTAMP_LENGTH,"timestamp'","'",3),
